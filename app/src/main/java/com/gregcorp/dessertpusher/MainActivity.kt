package com.gregcorp.dessertpusher
...
import com.gregcorp.dessertpusher.databinding.ActivityMainBinding
import timber.log.Timber

const val KEY_REVENUE = "key_revenue"
const val KEY_DESSERTS_SOLD = "key_desserts_sold"
const val KEY_SECONDS_COUNT = "secondsCount"
...
//        Log.i("MainActivity", "onCreate called")
        ...
        if (savedInstanceState != null) {
            ...
            desserTimer.secondsCount = savedInstanceState.getInt(KEY_SECONDS_COUNT)
        }
...
//        desserTimer.stopTimer()
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putInt(KEY_SECONDS_COUNT, desserTimer.secondsCount)
